...
def main():
    ...
    # plt.plot(bin_edges_base[1:], cdf_base_smooth,label="Baseline", color="black", linestyle="-",linewidth=3)
    plt.plot(bin_edges_0[1:], cdf_0_smooth,color="black", label="mode 0 generic kernel",linestyle="-")
    plt.plot(bin_edges_1[1:], cdf_1_smooth,color="red", label="mode 0 RT kernel",linestyle="-")
