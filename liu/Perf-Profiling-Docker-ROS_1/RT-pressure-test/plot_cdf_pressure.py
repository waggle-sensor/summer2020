...
def main():
    ...
    data_0 = np.loadtxt('generic_latency.log')
    data_1 = np.loadtxt('latency-yolov3.log')
    ...
    # plt.plot(bin_edges_base[1:], cdf_base_smooth,label="Baseline", color="black", linestyle="-",linewidth=3)
    plt.plot(bin_edges_0[1:], cdf_0_smooth,color="black", label="generic kernel",linestyle="-")
    plt.plot(bin_edges_1[1:], cdf_1_smooth,color="red", label="RT kernel",linestyle="-")
