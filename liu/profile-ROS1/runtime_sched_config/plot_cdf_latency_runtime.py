...
def main():
    ...
    data_0 = np.loadtxt('generic/latency_generic.log')
    data_1 = np.loadtxt('generic/latency_generic_sched.log')
    data_2 = np.loadtxt('rt/latency_rt.log')
    data_3 = np.loadtxt('rt/latency_rt_sched.log')
    ...
    # plt.plot(bin_edges_base[1:], cdf_base_smooth,label="Baseline", color="black", linestyle="-",linewidth=3)
    plt.plot(bin_edges_0[1:], cdf_0_smooth,color="red", label="Generic SCHED_OTHER",linestyle="-")
    plt.plot(bin_edges_1[1:], cdf_1_smooth,color="green", label="Generic SCHED_FIFO",linestyle="-")
    plt.plot(bin_edges_2[1:], cdf_2_smooth,color="blue",label="RT SCHED_OTHER",linestyle="-")
    plt.plot(bin_edges_3[1:], cdf_3_smooth,color="gray",label="RT SCHED_FIFO",linestyle="-")
    ...
    plt.savefig('runtime-latency.png', bbox_inches = "tight")
    plt.show()
