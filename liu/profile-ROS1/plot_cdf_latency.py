...
def main():
    ...
    data_0 = np.loadtxt('0_power_mode/latency.log')
    data_1 = np.loadtxt('1_power_mode/latency.log')
    data_2 = np.loadtxt('2_power_mode/latency.log')
    data_3 = np.loadtxt('3_power_mode/latency.log')
    data_4 = np.loadtxt('4_power_mode/latency.log')
    data_5 = np.loadtxt('5_power_mode/latency.log')
