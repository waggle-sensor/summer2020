...
#model.fit_generator(train_gen,validation_data=val_gen,callbacks = [checkpoint],use_multiprocessing=False,epochs=2)
model.fit(train_gen,validation_data=val_gen,callbacks = [checkpoint],use_multiprocessing=True,epochs=5)
