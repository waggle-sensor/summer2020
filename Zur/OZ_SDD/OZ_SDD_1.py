# Usage
# python OZ_SDD_1.py --input videos/test_video2.mp4 --output output/output_01.avi --yolo yolo-coco
# python OZ_SDD_1.py --input videos/pedestrians.mp4 --output output/output_01.avi --yolo yolo-coco
